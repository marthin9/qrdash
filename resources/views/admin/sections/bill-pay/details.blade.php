            ...
            <div class="row align-items-center mb-10-none">
                <div class="col-xl-4 col-lg-4 form-group">
                    <ul class="user-profile-list-two">
                        ...
                        <li class="four">{{ __("bill Type") }}: <span class="fw-bold">{{ @$data->details->bill_type_name }}</span></li>
                        <li class="five">{{ __("Bill Number") }}: <span class="fw-bold">{{ @$data->details->bill_number }}</span></li>
                ...
                <div class="col-xl-4 col-lg-4 form-group">
                    <ul class="user-profile-list two">
                        <li class="one">{{ __("Bill Amount") }}: <span>{{ get_amount($data->request_amount,get_default_currency_code()) }}</span></li>
